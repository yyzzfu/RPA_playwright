...
def test_create_gaoji_group_task(pw_page, get_kf):
    ...
    data = GaoJiGroupData.as_dict_class()
    my_page.gaoji_page.create_task_func(**data, task_type='群聊群发')
...
def test_gaoji_create_group_one_by_one_task(pw_page, get_kf):
    ...
    my_page.gaoji_page.navigate()
    data = GaoJiGroupData.as_dict_class()
    my_page.gaoji_page.create_task_func(**data, one_by_one=True, task_type='群聊群发')
...
def test_gaoji_create_person_task(pw_page, get_kf):
    my_page = PageIns.login_and_return_page_ins(pw_page, *get_kf)
    data = GaoJiPersonData.as_dict_class()
    my_page.gaoji_page.navigate()
    my_page.gaoji_page.create_task_func(**data, task_type='私聊群发')
...
def test_gaoji_create_notice_task(pw_page, get_kf):
    my_page = PageIns.login_and_return_page_ins(pw_page, *get_kf)
    data = GaoJiNoticeData.as_dict_class()
    my_page.gaoji_page.navigate()
    my_page.gaoji_page.create_task_func(**data, task_type='群发公告')
