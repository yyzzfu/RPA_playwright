...
@allure.epic('智能助理')
@allure.feature('群发任务')
@allure.title('高级群发-群聊群发（群发对象：指定群-选择客户群）--立即发送')
...
@allure.epic('智能助理')
@allure.feature('群发任务')
@allure.title('高级群发-群聊群发（群发对象：指定群-选择客户群）--定时发送')
...
@allure.epic('智能助理')
@allure.feature('群发任务')
@allure.title('高级群发-群聊群发（群发对象：指定群-选择客户群-指定的群单独发送）--立即发送')
...
@allure.epic('智能助理')
@allure.feature('群发任务')
@allure.title('高级群发-私聊群发（群发对象：按客户-指定客户）--立即发送')
# @pytest.mark.smoke
...
@allure.epic('智能助理')
@allure.feature('群发任务')
@allure.title('高级群发-群发公告（群发对象：指定群-选择客户群）--立即发送')
# @pytest.mark.smoke
