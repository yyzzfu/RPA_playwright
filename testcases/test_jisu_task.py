...
@allure.epic('智能助理')
@allure.feature('群发任务')
@allure.title('极速群发-群聊群发（群发对象：指定群-选择客户群）--立即发送')
# @pytest.mark.smoke
...
@allure.epic('智能助理')
@allure.feature('群发任务')
@allure.title('极速群发-群聊群发（群发对象：指定群-选择客户群）--定时发送')
...
@allure.epic('智能助理')
@allure.feature('群发任务')
@allure.title('极速群发-私聊群发（群发对象：按客户-选择客户）--立即发送')
# @pytest.mark.smoke
...
@allure.epic('智能助理')
@allure.feature('群发任务')
@allure.title('极速群发-私聊群发（群发对象：按客户-选择客户）--定时发送')
